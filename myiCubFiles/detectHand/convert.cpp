...
yarp::sig::ImageOf<yarp::sig::PixelMono16> converter::create_frame(list<AER_struct> i_lAER) {
    int size_stack;
    int _x;
    int _y;
    int _pol;
    ...
    yarp::sig::ImageOf<yarp::sig::PixelMono16> _tmp_cart_img = base_img;
...
void converter::send_frame(yarp::sig::ImageOf<yarp::sig::PixelMono16> i_img) {
    yarp::sig::ImageOf<yarp::sig::PixelMono16>& tmp = port.prepare();
    tmp = i_img;
    port.write();
}
